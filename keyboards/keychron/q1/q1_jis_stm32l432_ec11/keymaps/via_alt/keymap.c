...
#define KC_LWT KC_LIGHT_WASD_TOGGLE
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FN] = LAYOUT_all(
         ...
         KC_TRNS,            KC_LTTOG, KC_LATOG, KC_TKTOG, KC_FCTOG, KC_TRNS,  KC_TRNS,  KC_LWT,   KC_TRNS,  KC_TRNS,  KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case KC_FN_LAYER_COLOR_TOGGLE:
            ...
            return false;  // Skip all further processing of this key
        case KC_LIGHT_WASD_TOGGLE:
            if (record->event.pressed) {
                user_config.light_wasd ^= 1;
                eeconfig_update_user(user_config.raw);
            }
            return false;  // Skip all further processing of this key
        default:
...
bool get_light_wasd(void) {
    return user_config.light_wasd;
}
