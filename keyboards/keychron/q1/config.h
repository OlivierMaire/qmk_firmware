...
#define RGB_MATRIX_STARTUP_SAT 120 // Sets the default saturation value, if none has been set
#define RGB_MATRIX_STARTUP_VAL 55 // Sets the default brightness value, if none has been set
#define RGB_MATRIX_STARTUP_SPD 80 // Sets the default animation speed, if none has been set

/* bug fix */
#define TRANSIENT_EEPROM_SIZE 2049 